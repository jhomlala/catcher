class LocalizationOptions {
  ...
  LocalizationOptions(
    ...
    this.notificationReportModeContent = "Click here to send error report to support team.",
    this.dialogReportModeTitle = "Crash",
    this.dialogReportModeDescription = "Unexpected error occurred in application. Error report is ready to send to support team. Please click Accept to send error report or Cancel to dismiss report.",
    this.dialogReportModeAccept = "Accept",
    this.dialogReportModeCancel = "Cancel",
    this.pageReportModeTitle = "Crash",
    this.pageReportModeDescription = "Unexpected error occurred in application. Error report is ready to send to support team. Please click Accept to send error report or Cancel to dismiss report.",
  ...
  static LocalizationOptions buildDefaultChineseOptions() {
    return LocalizationOptions(
      ...
      dialogReportModeDescription: "应用程序中发生意外错误。 错误报告已准备好发送给支持团队。 请单击“接受”以发送错误报告，或单击“取消”以关闭报告。",
      dialogReportModeAccept: "接受",
      dialogReportModeCancel: "取消",
      pageReportModeTitle: "错误",
      pageReportModeDescription: "应用程序中发生意外错误。 错误报告已准备好发送给支持团队。 请单击“接受”以发送错误报告，或单击“取消”以关闭报告。",
  ...
  static LocalizationOptions buildDefaultHindiOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "समर्थन टीम को त्रुटि रिपोर्ट भेजने के लिए यहां क्लिक करें।.",
  ...
  static LocalizationOptions buildDefaultSpanishOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Haga clic aquí para enviar un informe de error al equipo de soporte.",
  ...
  static LocalizationOptions buildDefaultMalayOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Klik di sini untuk menghantar laporan ralat untuk menyokong pasukan.",
  ...
  static LocalizationOptions buildDefaultRussianOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Нажмите здесь, чтобы отправить отчет об ошибке в службу поддержки.",
  ...
  static LocalizationOptions buildDefaultPortugueseOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Clique aqui para enviar o relatório de erros à equipe de suporte.",
  ...
  static LocalizationOptions buildDefaultFrenchOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Cliquez ici pour envoyer un rapport d'erreur à l'équipe de support.",
  ...
  static LocalizationOptions buildDefaultItalianOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Clicca qui per inviare il report relativo all'errore al team di supporto.",
  ...
  static LocalizationOptions buildDefaultDutchOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Klik hier om het foutrapport te versturen naar het ondersteuningsteam.",
  ...
  static LocalizationOptions buildDefaultGermanOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "Klicken Sie hier, um einen Fehlerbericht an das Support-Team zu senden.",
  ...
  static LocalizationOptions buildDefaultArabicOptions() {
    return LocalizationOptions(
      ...
      notificationReportModeContent: "اضغط هنا لإرسال تقرير الخطأ إلى فريق الدعم",
      dialogReportModeTitle: "خطأ",
      dialogReportModeDescription: "حدث خطأ غير متوقع في التطبيق. التقرير الخطأ قادر على إرسال إلى فريق الدعم. اضغط على موافق لإرسال التقرير، أو على إلغاء لإزالة التقرير.",
      dialogReportModeAccept: "موافق",
      dialogReportModeCancel: "إلغاء",
      pageReportModeTitle: "خطأ",
      pageReportModeDescription: "حدث خطأ غير متوقع في التطبيق. التقرير الخطأ قادر على إرسال إلى فريق الدعم. اضغط على موافق لإرسال التقرير، أو على إلغاء لإزالة التقرير.",
      pageReportModeAccept: "موافق",
  ...
  LocalizationOptions copyWith({
    ...
    return LocalizationOptions(
      ...
      notificationReportModeTitle: notificationReportModeTitle ?? this.notificationReportModeTitle,
      notificationReportModeContent: notificationReportModeContent ?? this.notificationReportModeContent,
      dialogReportModeTitle: dialogReportModeTitle ?? this.dialogReportModeTitle,
      dialogReportModeDescription: dialogReportModeDescription ?? this.dialogReportModeDescription,
      dialogReportModeAccept: dialogReportModeAccept ?? this.dialogReportModeAccept,
      dialogReportModeCancel: dialogReportModeCancel ?? this.dialogReportModeCancel,
      pageReportModeTitle: pageReportModeTitle ?? this.pageReportModeTitle,
      pageReportModeDescription: pageReportModeDescription ?? this.pageReportModeDescription,
      ...
      toastHandlerDescription: toastHandlerDescription ?? this.toastHandlerDescription,
      snackbarHandlerDescription: snackbarHandlerDescription ?? this.snackbarHandlerDescription,
    );
  }
}
